...
This project intends to create a text corpus, from scratch and in spanish, to resolve the problem of binary clasification between text written in general natural language or "lectura facil", a term in spanish that means "easy lecture".
